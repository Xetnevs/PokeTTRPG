...
export default `query queryForAll {
  species: pokemon_v2_pokemonspecies(limit: 10000) {
    ...
    varieties: pokemon_v2_pokemons {
      ...
      moves: pokemon_v2_pokemonmoves(where: {pokemon_v2_movelearnmethod: {_or: [{name: {_eq: "level-up"}}, {name: {_eq: "machine"}}]}}) {
        level
        version_group_id
  ...
  abilities: pokemon_v2_ability {
    id
    name
    effect_description: pokemon_v2_abilityeffecttexts(where: {pokemon_v2_language: {name: {_eq: "en"}}}, limit: 1) {
      short_effect
      effect
    }
    flavor_texts:pokemon_v2_abilityflavortexts(where: {pokemon_v2_language: {name: {_eq: "en"}}}, limit: 1) {
      flavor_text
    }
  }
  moves: pokemon_v2_move {
    ...
    move_effect: pokemon_v2_moveeffect {
      effect_description: pokemon_v2_moveeffecteffecttexts(where: {pokemon_v2_language: {name: {_eq: "en"}}}, limit: 1) {
        short_effect
        effect
      }
    }
